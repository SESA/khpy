...
#        "
    ...
    proc displayObj {viewer group obj node netid} {
    ...
    proc displayObjs {} {
        ...
        foreach obj [getObjects] {
            ...
            set netid [lindex $objinfo 1]
            if { $netid == "0" } { 
                displayObj free "free" $obj $node $netid
            } else {
                displayObj [getViewer $netid] $netid $obj $node $netid
            }
        }
